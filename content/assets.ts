...
const IMAGE_ASSETS: Record<string, ImageSourcePropType> = {
  "learning/lg/coloring/ennyumba.png": require("@/assets/images/learning/lg/coloring/ennyumba.png"),
  "learning/lg/coloring/greeting.png": require("@/assets/images/learning/lg/coloring/greeting.png"),
  "learning/lg/coloring/maama.png": require("@/assets/images/learning/lg/coloring/maama.png"),
  "learning/lg/coloring/omwana.png": require("@/assets/images/learning/lg/coloring/omwana.png"),
  "learning/lg/coloring/taata.png": require("@/assets/images/learning/lg/coloring/taata.png"),
  "learning/lg/counting/books.png": require("@/assets/images/learning/lg/counting/books.png"),
  "learning/lg/counting/children.png": require("@/assets/images/learning/lg/counting/children.png"),
  "learning/lg/counting/cups.png": require("@/assets/images/learning/lg/counting/cups.png"),
  "learning/lg/counting/houses.png": require("@/assets/images/learning/lg/counting/houses.png"),
  "learning/lg/counting/water-cups.png": require("@/assets/images/learning/lg/counting/water-cups.png"),
  "learning/lg/menus/cards.png": require("@/assets/images/learning/lg/menus/cards.png"),
  "learning/lg/menus/learning.png": require("@/assets/images/learning/lg/menus/learning.png"),
  "learning/lg/menus/numbers.png": require("@/assets/images/learning/lg/menus/numbers.png"),
  "learning/lg/menus/puzzles.png": require("@/assets/images/learning/lg/menus/puzzles.png"),
  "learning/lg/menus/words.png": require("@/assets/images/learning/lg/menus/words.png"),
  "learning/lg/puzzles/book-and-water.png": require("@/assets/images/learning/lg/puzzles/book-and-water.png"),
  "learning/lg/puzzles/family-home.png": require("@/assets/images/learning/lg/puzzles/family-home.png"),
  "learning/lg/puzzles/greeting.png": require("@/assets/images/learning/lg/puzzles/greeting.png"),
  "learning/lg/stage-1/greeting-oli-otya.png": require("@/assets/images/learning/lg/stage-1/greeting-oli-otya.png"),
  "learning/lg/stage-1/reply-gyendi.png": require("@/assets/images/learning/lg/stage-1/reply-gyendi.png"),
  "learning/lg/stage-1/stage-card.png": require("@/assets/images/learning/lg/stage-1/stage-card.png"),
  "learning/lg/stage-1/story-greeting-1.png": require("@/assets/images/learning/lg/stage-1/story-greeting-1.png"),
  "learning/lg/stage-1/story-greeting-2.png": require("@/assets/images/learning/lg/stage-1/story-greeting-2.png"),
  "learning/lg/stage-1/story-greeting-3.png": require("@/assets/images/learning/lg/stage-1/story-greeting-3.png"),
  "learning/lg/stage-1/thanks-webale.png": require("@/assets/images/learning/lg/stage-1/thanks-webale.png"),
  "learning/lg/stage-1/work-greeting-gyebale-ko.png": require("@/assets/images/learning/lg/stage-1/work-greeting-gyebale-ko.png"),
  "learning/lg/stage-2/amazzi.png": require("@/assets/images/learning/lg/stage-2/amazzi.png"),
  "learning/lg/stage-2/ekitabo.png": require("@/assets/images/learning/lg/stage-2/ekitabo.png"),
  "learning/lg/stage-2/ennyumba.png": require("@/assets/images/learning/lg/stage-2/ennyumba.png"),
  "learning/lg/stage-2/maama.png": require("@/assets/images/learning/lg/stage-2/maama.png"),
  "learning/lg/stage-2/omwana.png": require("@/assets/images/learning/lg/stage-2/omwana.png"),
  "learning/lg/stage-2/stage-card.png": require("@/assets/images/learning/lg/stage-2/stage-card.png"),
  "learning/lg/stage-2/story-home-1.png": require("@/assets/images/learning/lg/stage-2/story-home-1.png"),
  "learning/lg/stage-2/story-home-2.png": require("@/assets/images/learning/lg/stage-2/story-home-2.png"),
  "learning/lg/stage-2/story-home-3.png": require("@/assets/images/learning/lg/stage-2/story-home-3.png"),
  "learning/lg/stage-2/story-home-4.png": require("@/assets/images/learning/lg/stage-2/story-home-4.png"),
  "learning/lg/stage-2/taata.png": require("@/assets/images/learning/lg/stage-2/taata.png"),
